          ...
          <p class="mb-0">
            ...
            if($florist_flower_shop_theme_lay == 'Excerpt'){ ?>
              <?php if(get_the_excerpt()) { ?>
                <?php $florist_flower_shop_excerpt = get_the_excerpt(); echo esc_html( florist_flower_shop_string_limit_words( $florist_flower_shop_excerpt, esc_attr(get_theme_mod('florist_flower_shop_excerpt_number','30')))); ?> <?php echo esc_html(get_theme_mod('florist_flower_shop_excerpt_suffix',''));?>
              <?php }?>
            <?php }?>
          </p>
