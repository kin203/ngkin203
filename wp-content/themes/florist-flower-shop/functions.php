...
function florist_flower_shop_setup() {
	...
	if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'florist-flower-shop') {
		wp_redirect(admin_url('themes.php?page=florist_flower_shop_guide'));
	}
}
endif;
